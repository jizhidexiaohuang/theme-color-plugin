...
const { setDefaultThemeColor } = require("./update-theme");
...
const themePluginOption = {
  ...
  matchColors: getAntdSerials(defaultThemeColor), // 主色系列
  // 改变样式选择器，解决样式覆盖问题
...
const initThemeColorPlugin = (themeColor) => {
  defaultThemeColor = themeColor;
  setDefaultThemeColor(themeColor);
  themePluginOption.matchColors = getAntdSerials(themeColor);
  return createThemeColorReplacerPlugin;
};

module.exports = initThemeColorPlugin;
